...
export const blogArticles: BlogArticle[] = [
  ...
  { id: 39, title: "Cadeau de Naissance : Le Livre Personnalisé Qui Émeut Tous les Parents", excerpt: "Le cadeau de naissance qui fait pleurer les parents : un livre personnalisé avec le prénom du bébé, son histoire unique. Création en 5 min, premier livre gratuit.", slug: "cadeau-naissance-livre-personnalise-bebe", image: "cadeau-naissance-livre-personnalise" },
  { id: 40, title: "Cadeau de Noël Personnalisé : Le Livre Où Votre Enfant Est le Héros", excerpt: "Offrez un cadeau de Noël inoubliable : un livre personnalisé où votre enfant vit une aventure de Noël. Son prénom, ses passions, illustrations IA.", slug: "cadeau-noel-livre-personnalise-enfant", image: "cadeau-noel-livre-personnalise-enfant" },
  { id: 41, title: "Livre Personnalisé 3-5 Ans : L'Âge d'Or de l'Imagination", excerpt: "Créez un livre personnalisé adapté aux 3-5 ans. Histoires avec son prénom, vocabulaire adapté, illustrations IA uniques. Premier livre gratuit.", slug: "livre-personnalise-enfant-3-5-ans", image: "livre-personnalise-enfant-3-5-ans" },
  ...
  { id: 52, title: "Idée Cadeau de Noël Fille : 15 Idées Originales qui Vont l'Émerveiller (2026)", excerpt: "Quel cadeau de Noël offrir à une fille en 2026 ? 15 idées testées : jouets créatifs, jeux, livres, expériences, et un cadeau personnalisé qui fait toujours son effet.", slug: "idee-cadeau-noel-fille", image: "idee-cadeau-noel-fille" },
  { id: 53, title: "Idée Cadeau de Noël Garçon : 15 Idées Originales qui Vont l'Émerveiller (2026)", excerpt: "Quel cadeau de Noël offrir à un garçon en 2026 ? 15 idées testées : jouets, jeux de construction, livres, expériences, et un cadeau personnalisé qui fait toujours son effet.", slug: "idee-cadeau-noel-garcon", image: "idee-cadeau-noel-garcon" }
];
...
export const BLOG_CATEGORIES: BlogCategory[] = [
  ...
  },
  {
    ...
    articleSlugs: [
      ...
      "idee-cadeau-noel-fille",
      "idee-cadeau-noel-garcon"
    ]
  },
  {
    slug: "sommeil",
