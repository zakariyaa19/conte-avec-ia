...
const PrenomPage: React.FC = () => {
  ...
  const faqQuestions = [
    ...
    },
    {
      ...
      answer: `Le premier livre est 100% gratuit (3 pages, 3 illustrations, PDF). Les suivants : 2,99€ par livre complet (20 pages) ou 9,99€/mois pour le Club (4 livres par mois). Aucune carte bancaire pour le gratuit.`,
    },
  ];
