...
const TRANCHES: Record<string, TrancheData> = {
  ...
  '3-5-ans': {
    ...
    pageCount: "3 pages gratuites, 20 pages en version complète",
    themes: [
    ...
    faqQuestions: [
      ...
      { question: "Combien coûte un livre personnalisé 3-5 ans ?", answer: "Premier livre 100% gratuit sur Contedia (3 pages, sans CB). Version complète 20 pages : 2,99€ unique. Club mensuel 1,99€ le premier mois puis 9,99€/mois (4 livres complets). Le coût annuel pour un enfant qui adore relire (~6-12 livres/an) : 18-36€ chez Contedia vs 150-400€ chez les concurrents imprimés." },
    ],
  },
  '6-8-ans': {
    slug: '6-8-ans',
    title: "Livre personnalisé enfant 6-8 ans : aventures pour lecteurs autonomes | Contedia",
    description: "Livre personnalisé pour enfant 6, 7 ou 8 ans : aventures riches, vocabulaire enrichi, 20 pages d'histoire 100% unique. Idéal pour la lecture autonome. Premier livre gratuit.",
    ...
    intro: "À 6-8 ans, votre enfant lit tout seul. Le **livre personnalisé enfant 6-8 ans** devient un outil puissant pour entretenir le plaisir de la lecture : il lit SA propre aventure, pas une histoire générique. Vocabulaire enrichi, intrigues plus complexes, 20 pages d'aventure illustrée 100% unique générée par IA. Premier livre gratuit sur Contedia.",
    pageCount: "3 pages gratuites, 20 pages en version complète",
    themes: [
    ...
    benefits: [
      { icon: '📖', title: "Lecture autonome", description: "Vocabulaire et longueur calibrés pour un enfant qui lit déjà : 20 pages, phrases moyennes, mots variés" },
    ...
    faqQuestions: [
      { question: "Mon enfant de 7 ans lit seul, le livre personnalisé est-il assez long ?", answer: "Oui, la version complète Contedia pour enfant 6-8 ans fait 20 pages avec un vrai roman court (paragraphes denses, intrigue à rebondissements). C'est l'équivalent d'un Petit Nicolas ou d'un Roald Dahl première lecture, mais avec VOTRE enfant comme héros. Compte 15-25 minutes de lecture autonome." },
      ...
      { question: "Combien coûte un livre personnalisé pour enfant 6-8 ans ?", answer: "Premier livre gratuit sur Contedia (3 pages, sans CB). Version complète 20 pages : 2,99€. Club mensuel pour 4 livres/mois : 1,99€ le premier mois puis 9,99€/mois. À 7-8 ans, votre enfant peut lire 1 livre par semaine — le Club est ultra rentable (~2€ par livre). Vs Wonderbly/Hourra Héros : 25-40€ par livre imprimé." },
    ],
  },
  '9-12-ans': {
    slug: '9-12-ans',
    ...
    faqQuestions: [
      ...
      { question: "Combien coûte un livre personnalisé pour pré-ado 9-12 ans ?", answer: "Premier livre gratuit sur Contedia (sans CB). Version complète 20 pages : 2,99€. Club mensuel : 1,99€ le premier mois puis 9,99€/mois pour 4 livres. À 9-12 ans, votre enfant peut dévorer 1-2 livres par semaine — le Club est imbattable. Vs concurrents : ils n'ont quasi rien pour cette tranche d'âge (Wonderbly s'arrête à 10 ans)." },
    ],
  },
};
