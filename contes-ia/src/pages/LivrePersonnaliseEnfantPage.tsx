...
const faqQuestions = [
  ...
  { question: "Le premier livre personnalisé enfant est-il vraiment gratuit ?", answer: "Oui, totalement gratuit. Pas de carte bancaire demandée, pas d'abonnement caché. Vous recevez un vrai livre complet (3 pages, 3 illustrations) par email. Si vous aimez, vous pouvez créer d'autres livres ou rejoindre le Club." },
