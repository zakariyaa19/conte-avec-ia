...
const ageGroups = [
  ...
  { age: "4-6 ans", title: "Aventures Magiques", description: "L'âge de l'imagination débordante ! Des contes éducatifs qui stimulent la curiosité et développent le langage de votre enfant.", features: ["Vocabulaire enrichi", "Histoires moyennes (8-20 pages)", "Dialogues simples", "Morale claire"], themes: ["Magie et féerie", "Amitié", "Découverte du monde", "Émotions"], icon: "🧚", color: "#98FB98" },
  { age: "6-8 ans", title: "Héros en Herbe", description: "Des récits plus complexes où votre enfant devient le héros. Parfait pour développer la confiance en soi et l'autonomie.", features: ["Phrases plus longues", "Histoires étoffées (12-20 pages)", "Défis à résoudre", "Valeurs importantes"], themes: ["Aventures épiques", "Courage et bravoure", "Sciences amusantes", "Cultures du monde"], icon: "🦸", color: "#87CEEB" },
