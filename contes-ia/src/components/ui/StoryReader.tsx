              ...
              <EndSlide key="end" data-slide-index={idx}>
                ...
                <EndContent>
                  ...
                  {isShared ? (
                    ...
                    <>
                      {/* 1. Envoyer à un proche — CTA principal */}
                      {onShare && (
                      ...
                      {/* 2. Partage Story — discret, inline */}
                      {(() => { const storyShareUrl = shareUrl || window.location.href; return (
                        <div style={{
                          ...
                          <button
                            onClick={() => {
                              const url = encodeURIComponent(storyShareUrl);
                      ...
                      {!isClub && (
                        ...
                        >
                          ...
                          <span style={{
                            display: 'inline-block', background: 'white',
                            color: '#E88888', fontWeight: 700, fontSize: '13px',
                      ...
                      {/* 4. Créer une nouvelle histoire — discret */}
                      {onCreateAnother && (
