...
interface CustomOccasionCardProps {
  value: string;
  label: string;
  imagePath: string;
  isSelected: boolean;
...
export const CustomOccasionCard: React.FC<CustomOccasionCardProps> = ({
  value,
  label,
  imagePath,
  isSelected,
  ...
  return (
    ...
    >
      ...
      <TextContainer>
        <Label>Occasion personnalisée</Label>
        <Description>Personnalisez l'occasion de votre conte</Description>
      </TextContainer>
